 ...
 * @author Ruhi ÇELİK
 */
public class seminerTablo extends javax.swing.JFrame {
...
private void updateTable(){
    String sql="select * from seminer where sicil=?";
    try{
...
public void TabloGez(){
    ...
    String tableClick=(jTable1.getModel().getValueAt(Row, 0).toString());
     try{   
    String sql="select * from seminer where id="+tableClick;
    ...
    while(rs.next()){
       ...
       jTextField1.setText(rs.getString("sure"));
       jTextArea1.setText(rs.getString("konusu"));
    }
    }catch(Exception e)
{
    }finally{
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jButton12, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 137, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        String sql="update seminer set id=?, sicil=?, tarih=?, konusu=?, sure=?  where id=?";
        try{
            ps=conn.prepareStatement(sql);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String sql="INSERT INTO seminer (sicil, sure, tarih, konusu) VALUES (?, ?, ?, ?)";
        try{
            ps=conn.prepareStatement(sql);
            ps.setInt(1, sicil);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (p==0){
            ...
            String sql= "delete from seminer where id=?";
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        try {
            ekseleYaz.writeToExcel(jTable1, "seminer.xlsx");
            
            Runtime.getRuntime().exec("rundll32 url.dll,FileProtocolHandler "+"seminer.xlsx");
            // TODO add your handling code here:
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        try {
         ...
         Logger.getLogger(seminerTablo.class.getName()).log(Level.SEVERE, null, ex);
     }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(seminerTablo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new seminerTablo().setVisible(true);
            }
        });
    }
