 ...
 * @author Ruhi ÇELİK
 */
public class gorevEkran extends javax.swing.JFrame {
...
emf=javax.persistence.Persistence.createEntityManagerFactory("personelOtamasyonPU");
 ...
 setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
    ...
    private void initComponents() {
        ...
        jLabel20.setText("Başlangıç");

        jLabel21.setText("Birim");
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jDateChooser3, javax.swing.GroupLayout.DEFAULT_SIZE, 124, Short.MAX_VALUE)
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.MatteBorder(null), "Buton Panel"));
...
String sql="INSERT INTO job (sicil, begin, end, senesi, birim, gorev, gorevsekli) VALUES (?, ?, ?, ?, ?,?,?)";
        try{
            ps=conn.prepareStatement(sql);
            ps.setInt(1, sicil);
            ps.setString(2, ((JTextField)jDateChooser3.getDateEditor().getUiComponent()).getText());
            ps.setString(3, ((JTextField)jDateChooser4.getDateEditor().getUiComponent()).getText());
            ps.setInt(4, yil);
...
ps.setInt(1, Integer.parseInt(jLabel17.getText()));
    ps.execute();
...
private void TabloGez() {
    ...
    if(rs.next()){
       ...
       jComboBox4.getModel().setSelectedItem(rs.getString(6));
       jComboBox3.getModel().setSelectedItem(rs.getString(8));
       jComboBox2.getModel().setSelectedItem(rs.getString(7));
       jDateChooser3.setDate(dateFormat.parse(rs.getString(3)));
       jDateChooser4.setDate(dateFormat.parse(rs.getString(4)));  
...
String sql="update job set sira=?, sicil=?, begin=?, end=?, senesi=?, birim=?, gorev=?, gorevsekli=? where sira=?";
try{
    ps=conn.prepareStatement(sql);
ps.setInt(1, Integer.parseInt(jLabel17.getText()));
ps.setInt(9, Integer.parseInt(jLabel17.getText()));
ps.setInt(2, sicil);
ps.setString(3, ((JTextField)jDateChooser3.getDateEditor().getUiComponent()).getText());
ps.setString(4, ((JTextField)jDateChooser4.getDateEditor().getUiComponent()).getText());
ps.setInt(5,yil);
ps.setString(6, jComboBox4.getSelectedItem().toString());
...
jDateChooser4.setDate(null);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        try {
            ekseleYaz.writeToExcel(jTable1, "gorev.xlsx");

            Runtime.getRuntime().exec("rundll32 url.dll,FileProtocolHandler "+"gorev.xlsx");            
// TODO add your handling code here:
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        try {
            pdfYap.pdfYapp(jTable1, "gorev.pdf");

            Runtime.getRuntime().exec("rundll32 url.dll,FileProtocolHandler "+"gorev.pdf");
        } catch (FileNotFoundException ex) {
            Logger.getLogger(yoneticiEkrani.class.getName()).log(Level.SEVERE, null, ex);
        } catch (DocumentException ex) {
            Logger.getLogger(yoneticiEkrani.class.getName()).log(Level.SEVERE, null, ex);
        } catch (IOException ex) {
        Logger.getLogger(gorevEkran.class.getName()).log(Level.SEVERE, null, ex);
    }
 ...
 KalanIzin_TF.setText(sorg.getSingleResult().getKalanyillikizin().toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(gorevEkran.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new gorevEkran().setVisible(true);
            }
        });
    }
